...
public class CartItemController {
	...
	//to get handbag details - to get the handbag object -> to get the price of the handbag
	@Autowired
...
public HandbagServices getHandbagServices() {
	return handbagServices;
}


public void setHandbagServices(HandbagServices handbagServices) {
...
public void addCartItem(@PathVariable(value = "isbn") int isbn){
	...
	//isbn=4
	Handbag handbag=handbagServices.getHandbagById(isbn);
	//1 1 1000 2 36
	...
	for(int i=0;i<cartItems.size();i++){
		...
		//3==2
		//3==3
		if(isbn==cartItem.getHandbag().getId()){
    		cartItem.setQuantity(cartItem.getQuantity() + 1 );
    		cartItem.setTotalPrice(cartItem.getQuantity() * handbag.getPrice());
