...
<body>
<c:url value="/admin/handbag/addHandbag" var="url"></c:url>
	<form:form  method="post" action="${url}" commandName="handbagFormObj" enctype="multipart/form-data">
		<table>
		<tr>
...
<td><form:input path="author"></form:input></td>
	...
	<tr>
	<td><form:input type="file" path="handbagImage"/></td>
	</tr>
	<tr>
	<td colspan="2"><input type="submit"value="AddHandbag"></td>
	</tr>
		</table>
	</form:form>
