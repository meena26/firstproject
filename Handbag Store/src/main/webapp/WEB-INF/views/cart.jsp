...
<div ng-app="myapp" ng-controller="handbagController">
...
<td>{{cartItem.handbag.title}}</td>
<td>{{cartItem.handbag.price}}</td>
...
<a href="<c:url value="/getAllHandbags"/>" >Continue shopping</a>
</div>
